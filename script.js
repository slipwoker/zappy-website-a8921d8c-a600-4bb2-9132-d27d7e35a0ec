    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Rinat Shaprut Adv. uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'a8921d8c-a600-4bb2-9132-d27d7e35a0ec',
                    name: data.name || '',
                    email: data.email || '',
